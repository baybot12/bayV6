...
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp abay ID
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo abay
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig quotes.abay05
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
Membuat quotes contoh : ${prefix}bikinquote Kamu gay & abay
➸ *${prefix}play*
...
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub orng & Hub
